...
class AdminCommentController extends AbstractController
{
    ...
    public function edit(Comment $comment,Request $request,ObjectManager $manager){
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            $this->addFlash("success","Le commentaire {$comment->getId()} a bien été enregistré");

            return $this->redirectToRoute('admin_comments_list');
        }

        return $this->render('admin/comment/edit.html.twig',['comments'=>$comment,'form'=>$form->createView()]);

    }

    /**
     * Suppression d'un commentaire via l'admin
